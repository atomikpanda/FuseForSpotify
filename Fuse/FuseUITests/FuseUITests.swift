...
class FuseUITests: XCTestCase {
    ...
    func testExample() {
        ...
        snapshot("04Playlists", timeWaitingForIdle: 5)
        ...
        snapshot("03Tracks", timeWaitingForIdle: 5)
        app.navigationBars["Fuse.PlaylistView"].buttons["statsIcon"].tap()
        snapshot("01Stats", timeWaitingForIdle: 5)
        ...
        snapshot("02Operations", timeWaitingForIdle: 5)
